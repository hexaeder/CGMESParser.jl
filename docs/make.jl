...
DocMeta.setdocmeta!(CGMESParser, :DocTestSetup, :(using CGMESParser); recursive=true)
...
function preprocess_html_hover(c)
    ...
    \1\2
    #-
    CGMESParser.html_hover_map() #hide
    #-
    """)
end
...
kwargs = (;
    ...
    sitename="CGMESParser.jl",
    root=joinpath(pkgdir(CGMESParser), "docs"),
    linkcheck=true, # checks if external links resolve
    pagesonly=true,
    format=Documenter.HTML(;
        canonical="https://hexaeder.github.io/CGMESParser.jl",
        edit_link="main",
        assets=String[],
        ansicolor = true,
    ...
    pages=[
        "Home" => "index.md",
        "Tutorials" => [
            "Walking the Object Graph" => "generated/walking_the_graph.md",
            "Inspecting a Dataset" => "generated/inspecting_a_dataset.md",
        ],
        "API" => "api.md",
    ],
...
if haskey(ENV,"GITHUB_ACTIONS")
    ...
    deploydocs(;
        repo="github.com/hexaeder/CGMESParser.jl",
        devbranch="main",
        push_preview=true
    )
