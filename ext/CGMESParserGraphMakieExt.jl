module CGMESParserGraphMakieExt
...
using CGMESParser: CGMESParser, AbstractCIMCollection, CIMCollectionComparison, CIMExtension,
                   CIMObject, CIMRef, base_object, extensions, follow_ref, getname, hasname,
                   is_class, is_external_ref, objects, properties
import CGMESParser: inspect_collection, inspect_node, inspect_comparison, html_hover_map
